...
{
    /// <summary>
    /// A maker of FaceLessBook Repositories.
    /// </summary>
    /// <remarks>
    ...
    {
        /// <summary>
        /// Return the runtime FaceLessBook repository factory functions,
        /// each one is a factory for a repository of a particular type.
        /// </summary>
        /// <remarks>
        /// MODIFY THIS METHOD TO ADD CUSTOM CODE FUNCTIONS
        /// </remarks>
        private IDictionary<Type, Func<DbContext, object>> GetFaceLessBookFactories()
        {
            //TODO: implement custom repositories
            return new Dictionary<Type, Func<DbContext, object>>
                {
                   {typeof(IFriendRepository), context => new FriendRepository(context)},
                };
        ...
        /// <summary>
        /// Constructor that initializes with runtime FaceLessBook repository factories
        /// </summary>
        public RepositoryFactories()
        {
            _repositoryFactories = GetFaceLessBookFactories();
        }
